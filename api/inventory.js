// api/inventory.js - Vercel Serverless Function for Inventory API
...
module.exports = async (req, res) => {
    ...
    try {
        switch (req.method) {
            ...
            case 'PUT':
                const { id: putId } = req.query; // For PUT, ID often comes from query params in serverless
            ...
            case 'DELETE':
                const { id: deleteId } = req.query; // For DELETE, ID often comes from query params in serverless
